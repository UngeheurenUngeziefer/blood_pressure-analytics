...
class Pressure:
	''' class aggregating analytics of blood pressure from excel file '''
	...
	def __init__(self, excel, sheet_name):
		...
		# converting Date and Time to date and time datatypes
		...
		self.df['Sum of systolic and diastolic pressure'] = \
													self.df.Upper + self.df.Down


		# filling the NULL time records if we know time of near records
